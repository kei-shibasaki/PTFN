...
from scripts.utils import convert_state_dict, load_fake_img, load_option, pad_tensor, tensor2ndarray
...
def generate_images(opt, checkpoint_path, out_dir, noise_levels, generate_inter_img=False):
    ...
    for idx_dataset, dataset_path in enumerate(dataset_paths):
        ...
        for sigma in noise_levels:
            ...
            val_dataset = SingleVideoDenoisingDatasetTest(opt, sigma, max_frames=100, margin_frames=10, return_idx=True)
...
if __name__=='__main__':
    ...
    out_dir = f'results/{model_name}_set8'
