...
CUDA_VISIBLE_DEVICES=0,1,2,3 python -m train_codes.train_dp -c config/config_test.json
CUDA_VISIBLE_DEVICES=6,7 python -m train_codes.train_dp -c config/config_test.json
CUDA_VISIBLE_DEVICES=0,1,2,3 python -m train_codes.train_progressive_dp -c config/config_test_dp_pro.json
CUDA_VISIBLE_DEVICES=6,7 python -m train_codes.train_progressive_dp -c config/config_test_pro.json
