...
CUDA_VISIBLE_DEVICES=4,5 python -m train_codes.train_mimo_dp -c config/config_test_dp.json
CUDA_VISIBLE_DEVICES=2,3 python -m train_codes.train_wnet -c config/config_wnet.json


CUDA_VISIBLE_DEVICES=5 python -m eval_codes.generate_images_bsvd -c experiments/wnet/config_wnet.json
