...
CUDA_VISIBLE_DEVICES=6 python -m train_codes.train_naf2 -c config/config_test2.json
CUDA_VISIBLE_DEVICES=3 python -m train_codes.train_naf3 -c config/config_test.json
