...
CUDA_VISIBLE_DEVICES=2 python temp.py
...
CUDA_VISIBLE_DEVICES=5 python -m train_codes.train_mimo_multi -c config/config_test.json


CUDA_VISIBLE_DEVICES=5 python -m eval_codes.generate_images_davis -c experiments/wnet/config_wnet.json
...
CUDA_VISIBLE_DEVICES=3 python -m eval_codes.generate_images_bsvd_set8 -c experiments/wnet/config_wnet.json
